...
export function Gallery({ images }: GalleryProps) {
  return (
    <section id="gallery" className="bg-white px-4 py-12 sm:px-8 sm:py-20 lg:px-10 lg:py-24">
      <div className="mx-auto max-w-7xl">
        <SectionHeading
          ...
          align="center"
        />
        <div className="grid auto-rows-[190px] gap-3 sm:auto-rows-[240px] sm:gap-4 md:auto-rows-[280px] md:grid-cols-4">
          {images.map((item, index) => (
            <motion.article
              key={item.title}
              className={`group relative overflow-hidden rounded-[1.2rem] sm:rounded-[1.6rem] ${
